...
class PlaylistWidgetReceiver : AppWidgetProvider() {
    ...
    private fun openTargetInApp(context: Context, source: Intent) {
        val activityIntent = Intent(context, MainActivity::class.java).apply {
            action = "com.oli.music.action.OPEN_WIDGET_TARGET"
    ...
    companion object {
        ...
        const val ACTION_PLAY_TARGET = "com.oli.music.widget.playlists.PLAY_TARGET"
        const val ACTION_UPDATE_WIDGET = "com.oli.music.widget.playlists.UPDATE_WIDGET"
