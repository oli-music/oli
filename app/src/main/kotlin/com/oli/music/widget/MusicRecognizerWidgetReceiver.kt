...
import com.oli.music.recognition.MusicRecognitionService
import com.oli.music.widget.MusicRecognizerWidgetService.Companion.ALBUM_ART_CACHE_FILE
import com.oli.music.widget.MusicRecognizerWidgetService.Companion.PREF_ARTIST_NAME
import com.oli.music.widget.MusicRecognizerWidgetService.Companion.PREF_COVER_ART_PATH
import com.oli.music.widget.MusicRecognizerWidgetService.Companion.PREF_ERROR_MESSAGE
import com.oli.music.widget.MusicRecognizerWidgetService.Companion.PREF_PULSE_FRAME
import com.oli.music.widget.MusicRecognizerWidgetService.Companion.PREF_SONG_TITLE
import com.oli.music.widget.MusicRecognizerWidgetService.Companion.PREF_STATE
import com.oli.music.widget.MusicRecognizerWidgetService.Companion.PREFS_NAME
import com.oli.music.widget.MusicRecognizerWidgetService.Companion.STATE_ERROR
import com.oli.music.widget.MusicRecognizerWidgetService.Companion.STATE_IDLE
import com.oli.music.widget.MusicRecognizerWidgetService.Companion.STATE_LISTENING
import com.oli.music.widget.MusicRecognizerWidgetService.Companion.STATE_NO_MATCH
import com.oli.music.widget.MusicRecognizerWidgetService.Companion.STATE_PROCESSING
import com.oli.music.widget.MusicRecognizerWidgetService.Companion.STATE_SUCCESS
import java.io.File
...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
        ...
        if (!MusicRecognitionService.hasRecordPermission(context)) {
            context.startActivity(
                Intent(context, MainActivity::class.java).apply {
                    action = "com.oli.music.action.RECOGNITION"
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "com.oli.music.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "com.oli.music.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "com.oli.music.widget.recognizer.RESET"
    }
}
