...
import com.oli.music.constants.MaxImageCacheSizeKey
import com.oli.music.constants.MaxSongCacheSizeKey
import com.oli.music.extensions.tryOrNull
...
import com.oli.music.ui.utils.formatFileSize
        ...
        ActionPromptDialog(
            ...
            onConfirm = {
                androidx.media3.exoplayer.offline.DownloadService.sendRemoveAllDownloads(
                    context,
                    com.oli.music.playback.ExoDownloadService::class.java,
                    false
                )
