...
import com.oli.music.constants.AutomixDebugOverlayKey
...
import com.oli.music.constants.EnableGoogleCastKey
...
import com.oli.music.constants.SeekExtraSeconds
...
import com.oli.music.constants.EnableExportAsMp3Key
...
highlightKey: String? = null) {
    ...
    val (dataSaverEnabled, onDataSaverEnabledChange) = rememberPreference(
        key = com.oli.music.constants.DataSaverEnabledKey,
        defaultValue = false
    )
    ...
    val (downloadQuality, onDownloadQualityChange) = rememberEnumPreference(
        com.oli.music.constants.DownloadQualityKey,
        defaultValue = com.oli.music.constants.DownloadQuality.YOUTUBE
    )
    ...
    if (showDownloadQualityDialog) {
        EnumDialog(
            ...
            onSelect = {
                if (it == com.oli.music.constants.DownloadQuality.LOSSLESS) {
            ...
            values = listOf(com.oli.music.constants.DownloadQuality.YOUTUBE, com.oli.music.constants.DownloadQuality.LOSSLESS),
            valueText = {
                when (it) {
                    com.oli.music.constants.DownloadQuality.YOUTUBE -> "YouTube Music (AAC/Default)"
                    com.oli.music.constants.DownloadQuality.LOSSLESS -> "Lossless"
                }
            }
        )
    }
    ...
    Column(
        ...
        if (showLosslessAudioWarning) {
            DefaultDialog(
                ...
                buttons = {
                    TextButton(onClick = {
                        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://oli.app/donate"))
            ...
            DefaultDialog(
                ...
                buttons = {
                    ...
                    TextButton(onClick = {
                        ...
                        onDownloadQualityChange(com.oli.music.constants.DownloadQuality.LOSSLESS)
                    }) {
                        Text(stringResource(R.string.enable))
                    }
                }
        ...
        // Removed for Oli rebrand: was the original project's personal funding-progress
        // widget (buymeacoffee.com/iad1tya, support.iad1tya.cyou). Add Oli's own if desired.
    ...
    isHighlighted = (highlightKey == stringResource(R.string.export_desc)),
                ...
                Material3SettingsItem(
                    ...
                    onClick = { navController.navigate("settings/oli_extractor") }
                )
            )
        )
