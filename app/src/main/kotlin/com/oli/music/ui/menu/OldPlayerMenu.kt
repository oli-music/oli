                ...
                items = buildList {
                    add(
                        Material3MenuItemData(
                            customComposable = {
                                com.oli.music.ui.component.CastButton(asMenuItem = true)
                            }
                        )
                    )
                    ...
                    add(
                        Material3MenuItemData(
                            ...
                            onClick = {
                                ...
                                androidx.media3.exoplayer.offline.DownloadService.sendRemoveDownload(context, com.oli.music.playback.ExoDownloadService::class.java, mediaMetadata.id, false)
