...
object IconUtils {
    fun setIcon(context: Context, isDynamic: Boolean, isLegacy: Boolean) {
        ...
        val dynamic = ComponentName(context, "com.oli.music.MainActivityAlias")
        val static = ComponentName(context, "com.oli.music.MainActivityStatic")
        val legacy = ComponentName(context, "com.oli.music.MainActivityLegacy")
