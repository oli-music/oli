...
object LosslessAPI {
    ...
    private suspend fun fetchMusicList(): List<LosslessTrack> = withContext(Dispatchers.IO) {
        ...
        try {
            val request = Request.Builder()
                .url("https://raw.githubusercontent.com/oli-music/oli-lossless/refs/heads/main/music.json")
                .get()
                .build()
    ...
    suspend fun search(queryTitle: String, queryArtist: String): LosslessTrack? {
        ...
        return track?.let {
            val resolvedUrl = it.url.replace(
                "https://lossless.oli.app/Music/",
                "https://raw.githubusercontent.com/oli-music/oli-lossless/main/Music/"
            )
    ...
    suspend fun getDonationGoal(): DonationGoal = withContext(Dispatchers.IO) {
        try {
            val request = Request.Builder()
                .url("https://lossless.oli.app/goal.json")
                .get()
                .build()
