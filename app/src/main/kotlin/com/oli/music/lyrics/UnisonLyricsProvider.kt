...
import com.oli.music.unison.Unison
import com.oli.music.constants.UnisonLyricsEnabledKey
...
object UnisonLyricsProvider : LyricsProvider {
    ...
    private fun convertIfTTML(content: String): String {
        return if (content.trimStart().startsWith("<tt", ignoreCase = true)) {
            val parsedLines = com.oli.music.betterlyrics.TTMLParser.parseTTML(content)
            com.oli.music.betterlyrics.TTMLParser.toLRC(parsedLines)
        } else {
            content
        }
    }
