...
import com.oli.music.constants.MediaSessionConstants
...
constructor(
                            ...
                            parentId.startsWith("${MusicService.YOUTUBE_PLAYLIST}/") -> {
                                ...
                                try {
                                    val songs = YouTube.playlist(playlistId).getOrNull()?.songs
                                        ...
                                        ?.filterVideoSongs(context.dataStore.get(HideVideoSongsKey, false) || context.dataStore.get(com.oli.music.constants.DataSaverEnabledKey, false))
                                        ?: emptyList()
    ...
    private fun com.oli.music.db.entities.Playlist.toBrowsableMediaItem() = browsableMediaItem(
