...
import com.oli.music.utils.enumPreference
...
constructor(
    ...
    private val downloadQuality by enumPreference(context, com.oli.music.constants.DownloadQualityKey, com.oli.music.constants.DownloadQuality.YOUTUBE)
            ...
            val playbackData = runBlocking(Dispatchers.IO) {
                YTPlayerUtils.playerResponseForPlayback(
                    ...
                    audioQuality = when (downloadQuality) {
                        com.oli.music.constants.DownloadQuality.LOSSLESS -> AudioQuality.LOSSLESS
