...
This document provides instructions for setting up the Oli project for development.
...
Oli supports AI-powered lyrics translation. You can configure this in **Settings -> AI Settings**.
