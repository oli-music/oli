...
Thank you for your interest in contributing to Oli! This document provides comprehensive guidelines and information for contributors.
...
3. Add the upstream repository:
   ```bash
   git remote add upstream https://github.com/oli-music/oli.git
   ```
...
2. Add Android apps with package names:
   - `com.oli.music` (release)
   - `com.oli.music.debug` (debug)
...
When contributing to Oli, it's crucial to handle sensitive information properly:
...
./gradlew test --tests "com.oli.music.MusicPlayerTest"
...
1. Check the [GitHub Discussions](https://github.com/oli-music/oli/discussions)
...
Thank you for contributing to Oli!
