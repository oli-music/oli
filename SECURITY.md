...
If you discover a security vulnerability in Oli, please report it responsibly:

1. **Do NOT** create a public GitHub issue
2. Email us at: [security@oli.app](mailto:security@oli.app)
...
Oli is committed to user privacy:
...
- Email: [security@oli.app](mailto:security@oli.app)
- GitHub: Create a private security advisory

Thank you for helping keep Oli secure!
